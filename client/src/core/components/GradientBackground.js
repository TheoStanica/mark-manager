...
const GradientBackground = () => {
  ...
  return <Box sx={gradientBackgroundStyle(mode, isMobile)}></Box>;
};
...
const gradientBackgroundStyle = (mode, isMobile) => ({
  position: 'fixed',
  minHeight: '100vh',
  width: '100%',
  top: 0,
  ...
  animation: isMobile ? 'none' : 'bg-animation 25s ease-in-out infinite',
